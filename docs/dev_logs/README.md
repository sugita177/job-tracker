...
- **言語仕様 (PHP 8.x)**
  ...
  - 日時標準規格 `DateTimeImmutable::ATOM`: [03_api_usecases.md#5-api-レスポンスの日時表現と標準規格datetimeimmutableatom](03_api_usecases.md#5-api-レスポンスの日時表現と標準規格datetimeimmutableatom)
- **テスト (Pest PHP / TDD)**
...
- **設計思想・アーキテクチャ**
  ...
  - 多重防御によるテナント分離セキュリティ: [03_api_usecases.md#1-多重防御defense-in-depthによるテナント分離セキュリティ](03_api_usecases.md#1-多重防御defense-in-depthによるテナント分離セキュリティ)
